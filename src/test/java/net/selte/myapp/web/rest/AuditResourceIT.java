...
import net.selte.myapp.config.audit.AuditEventConverter;
import net.selte.myapp.domain.PersistentAuditEvent;
import net.selte.myapp.repository.PersistenceAuditEventRepository;
import net.selte.myapp.security.AuthoritiesConstants;

import net.selte.myapp.service.AuditEventService;
